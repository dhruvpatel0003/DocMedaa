...
const ProfilePage = () => {
  ...
  const openEditModal = (section) => {
    ...
    switch (section) {
      ...
      case "timing":
        setEditData({
          clinicTimings: getInitialClinicTimings(user?.clinicTimings),
        });
        break;
      default:
        break;
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      if (editData.hospitalName !== undefined)
        profileData.hospitalName = editData.hospitalName;
      if (editData.hospitalPhone !== undefined)
        profileData.hospitalPhone = editData.hospitalPhone;
      if (editData.hospitalEmail !== undefined)
        profileData.hospitalEmail = editData.hospitalEmail;
      if (editData.yearsOfExperience !== undefined)
        profileData.yearsOfExperience = editData.yearsOfExperience;
      if (editData.educationLevel !== undefined)
        profileData.educationLevel = editData.educationLevel;
      if (editData.specialty !== undefined)
        profileData.specialty = editData.specialty;
      if (editData.fullName !== undefined)
      ...
      if (response.success) {
        ...
        // 2) Update localStorage userProfile via AuthContext helper
        updateStoredProfile(profileData);
          ...
          <div className="profile-card">
            ...
            <div className="card-body">
              <div className="info-row">
                ...
                <p>{reduxUser?.fullName || "N/A"}</p>
              </div>
              <div className="info-row">
                <label>Email</label>
                <p>{reduxUser?.email || "N/A"}</p>
              </div>
              <div className="info-row">
                <label>Role</label>
                <p className="role-badge">
                  {reduxUser?.role
                    ? reduxUser.role.charAt(0).toUpperCase() +
                      reduxUser.role.slice(1)
                    : "N/A"}
                </p>
              </div>
            </div>
          ...
          <div className="profile-card">
            ...
            <div className="card-body">
              <div className="info-row">
                ...
                <p>{reduxUser?.phone || "Not provided"}</p>
              </div>
              <div className="info-row">
                <label>Address</label>
                <p>{reduxUser?.address || "Not provided"}</p>
              </div>
            </div>
            <div className="card-footer">
              <button
          ...
          {isPatient && (
            <div className="profile-card">
              ...
              <div className="card-body">
                <div className="info-row">
                  <label>Age</label>
                  <p>{reduxUser?.age || "Not provided"}</p>
                </div>
                <div className="info-row">
                  <label>Gender</label>
                  <p>{reduxUser?.gender || "Not provided"}</p>
                </div>
                <div className="info-row">
                  <label>Health Conditions</label>
                  {reduxUser?.healthConditions &&
                  reduxUser.healthConditions.length > 0 ? (
                    <div className="conditions-list">
                      {reduxUser.healthConditions.map((condition, index) => (
              ...
              <div className="profile-card">
                ...
                <div className="card-body">
                  <div className="info-row">
                    ...
                    <p>{reduxUser?.hospitalName || "Not provided"}</p>
                  </div>
                  <div className="info-row">
                    <label>Hospital Phone</label>
                    <p>{reduxUser?.hospitalPhone || "Not provided"}</p>
                  </div>
                  <div className="info-row">
                    <label>Hospital Email</label>
                    <p>{reduxUser?.hospitalEmail || "Not provided"}</p>
                  </div>
                </div>
                <div className="card-footer">
                  <button
              ...
              <div className="profile-card">
                ...
                <div className="card-body">
                  <div className="info-row">
                    ...
                    <p>
                      {reduxUser?.yearsOfExperience || "Not provided"} years
                    </p>
                  </div>
                  <div className="info-row">
                    <label>Highest Education</label>
                    <p>{reduxUser?.educationLevel || "Not provided"}</p>
                  </div>
                  <div className="info-row">
                    <label>Specialty</label>
                    <p>{reduxUser?.specialty || "Not provided"}</p>
                  </div>
                </div>
                <div className="card-footer">
                  <button
                    className="btn btn-secondary"
                    onClick={() => openEditModal("credentials")}
                  >
                    Edit Credentials
                  </button>
                </div>
                ...
                {editingSection === "basic" && (
                  <>
                    <CustomTextField
                      ...
                      onChange={(value) => handleEditChange("fullName", value)}
                      type="text"
                    />
                    <CustomTextField
                      hint="Email"
                ...
                {editingSection === "health" && (
                  <>
                    <CustomTextField
                      hint="Age"
                      value={editData.age}
                      onChange={(value) => handleEditChange("age", value)}
                      type="number"
                    />
                ...
                {editingSection === "professional" && (
                  <>
                    <CustomTextField
                      ...
                      onChange={(value) =>
                        handleEditChange("hospitalName", value)
                      }
                      type="text"
                    />
                    <CustomTextField
                      hint="Hospital Phone"
                      value={editData.hospitalPhone}
                      onChange={(value) =>
                        handleEditChange("hospitalPhone", value)
                      }
                      type="tel"
                    />
                    <CustomTextField
                      ...
                      onChange={(value) =>
                        handleEditChange("hospitalEmail", value)
                      }
                      type="email"
                    />
                  </>
                ...
                {editingSection === "credentials" && (
                  <>
                    <CustomTextField
                      ...
                      onChange={(value) =>
                        handleEditChange("yearsOfExperience", value)
                      }
                      type="number"
                    />
                    <CustomTextField
                      ...
                      onChange={(value) =>
                        handleEditChange("educationLevel", value)
                      }
                      type="text"
                    />
                    <CustomTextField
                      ...
                      onChange={(value) => handleEditChange("specialty", value)}
                      type="text"
                    />
                  </>
                )}
                  ...
                  <div className="clinic-timings-edit">
                    {defaultDays.map((day) => (
                      <div key={day} className="timing-row-block">
                        <label>{day}</label>
                        {(editData.clinicTimings?.[day] || []).map(
                          (slot, idx) => (
                            <div key={idx} className="timing-row">
                              <input
                                ...
                                value={slot.start}
                                onChange={(e) =>
                                  setTimeSlot(day, idx, "start", e.target.value)
                                }
                              />
                              <span>to</span>
                              <input
                                ...
                                value={slot.end}
                                onChange={(e) =>
                                  setTimeSlot(day, idx, "end", e.target.value)
                                }
                              />
                              <button
                                type="button"
                    ...
                    <small>
                      Add multiple slots for any day. Remove all to mark as
                      closed.
                    </small>
                  </div>
                )}
